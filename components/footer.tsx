...
export function Footer() {
  ...
  const socialLinks = [
    { href: "https://facebook.com/allianzy", icon: FacebookIcon, label: "Facebook" },
    { href: "https://instagram.com/allianzy", icon: InstagramIcon, label: "Instagram" },
    { href: `https://wa.me/${WHATSAPP_NUMBER}`, icon: WhatsAppIcon, label: "WhatsApp" },
    { href: "https://linkedin.com/company/allianzy", icon: LinkedInIcon, label: "LinkedIn" },
    { href: "mailto:hello@allianzy.com", icon: Mail, label: "Email" },
  ]
